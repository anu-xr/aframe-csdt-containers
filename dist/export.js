...
var _CSDTDistCsdtDefault = _parcelHelpers.interopDefault(_CSDTDistCsdt);
...
AFRAME.registerComponent('csdt-container', {
  ...
  init: function () {
    ...
    if (!window.CSDT) window.CSDT = new _CSDTDistCsdtDefault.default();
  ...
  initializeIframe: function () {
    ...
    if (data.enablePreview === true) {
      ...
      document.addEventListener(CSDT.messages.preview.getResponseTextFromChild(el.conn.hash), res => {
...
},{"../CSDT/dist/csdt":"b1pkp","./constants":"5vBc0","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"b1pkp":[function(require,module,exports) {
...
(function (modules, entry, mainEntry, parcelRequireName, globalName) {
  ...
  "3Wl5K": [function (require, module, exports) {
    ...
    class Connection {
      constructor(url) {
        this.url = String(url);
        this.iframe = _helpers.addIframe(this.url);
        ...
        this.iframe.addEventListener('load', () => {
          this.sendMessageWithResponse(_constants.INTERNAL_MESSAGES.open, this.hash).then(() => {
  ...
  "2fXzb": [function (require, module, exports) {
    ...
    */
      ...
      get(name, TypeConstructor = AbstractType) {
        ...
        if (TypeConstructor !== AbstractType && Constr !== TypeConstructor) {
          if (Constr === AbstractType) {
            ...
            const t = new TypeConstructor();
            t._map = type._map;
            type._map.forEach(/** @param {Item?} n*/
            n => {
              for (; n !== null; n = n.left) {
                // @ts-ignore
                n.parent = t;
    ...
    class UpdateEncoderV2 extends DSEncoderV2 {
      ...
      toUint8Array() {
        ...
        // this is a feature flag that we might use in the future
    ...
    */
    const integrateStructs = (transaction, store, clientsStructRefs) => {
      ...
      * @type {GC|Item}
      */
      let stackHead = /** @type {any}*/
      curStructsTarget.refs[/** @type {any}*/
      curStructsTarget.i++];
        ...
        if (stackHead.constructor !== Skip) {
          ...
          if (offset < 0) {
            ...
            if (missing !== null) {
              ...
              */
              const structRefs = clientsStructRefs.get(/** @type {number}*/
              missing) || ({
                refs: [],
                i: 0
              });
      ...
      if (restStructs.clients.size > 0) {
        ...
        // => no need for an extra function call, just write 0 deletes
        return {
          missing: missingSV,
    ...
    */
    const readUpdateV2 = (decoder, ydoc, transactionOrigin, structDecoder = new UpdateDecoderV2(decoder)) => transact(ydoc, transaction => {
      ...
      if (store.pendingDs) {
        ...
        // read 0 structs, because we only encode deletes in pendingdsupdate
    ...
    */
    const writeStateVector = (encoder, sv) => {
      ...
      sv.forEach((clock, client) => {
        encoding__namespace.writeVarUint(encoder.restEncoder, client);
        // @todo use a special client decoder that is based on mapping
        encoding__namespace.writeVarUint(encoder.restEncoder, clock);
      });
      return encoder;
    };
    ...
    * @function
    */
    const callEventHandlerListeners = (eventHandler, arg0, arg1) => f__namespace.callAll(eventHandler.l, [arg0, arg1]);
    class ID {
      /**
    ...
    class PermanentUserData {
        ...
        */
        const initUser = (user, userDescription) => {
          ...
          */
          ...
          const addClientId = /** @param {number} clientid*/
          clientid => this.clients.set(clientid, userDescription);
          ds.observe(/** @param {YArrayEvent<any>} event*/
          event => {
          ...
          ids.observe(/** @param {YArrayEvent<any>} event*/
      ...
      */
      setUserMapping(doc, clientid, userDescription, {filter = () => true} = {}) {
        ...
        doc.on('afterTransaction', /** @param {Transaction} transaction*/
        transaction => {
          setTimeout(() => {
    ...
    * @function
    */
    const getItem = /** @type {function(StructStore,ID):Item}*/
    find;
    /**
    * @param {Transaction} transaction
    * @param {Array<Item|GC>} structs
      ...
      if (left.deleted === right.deleted && left.constructor === right.constructor) {
        if (left.mergeWith(right)) {
          ...
          right.parent._map.get(right.parentSub) === right) {
            /** @type {AbstractType<any>}*/
            right.parent._map.set(right.parentSub, /** @type {Item}*/
            left);
          }
        }
      }
      ...
      */
      ...
      transact(doc, transaction => {
        while (stack.length > 0 && result === null) {
          const store = doc.store;
          const stackItem = /** @type {StackItem}*/
          stack.pop();
          /**
          * @type {Set<Item>}
          */
          ...
          */
          ...
          iterateDeletedStructs(transaction, stackItem.insertions, struct => {
            if (struct instanceof Item) {
              ...
              if (!struct.deleted && scope.some(type => isParentOf(type, /** @type {Item}*/
              struct))) {
      ...
      */
      constructor(typeScope, {captureTimeout = 500, deleteFilter = () => true, trackedOrigins = new Set([null])} = {}) {
        ...
        */
        ...
        this.scope[0].doc;
        this.lastChange = 0;
        this.doc.on('afterTransaction', /** @param {Transaction} transaction*/
        transaction => {
          ...
          iterateDeletedStructs(transaction, transaction.deleteSet, /** @param {Item|GC} item*/
          item => {
    ...
    const mergeUpdatesV2 = (updates, YDecoder = UpdateDecoderV2, YEncoder = UpdateEncoderV2) => {
      ...
      */
      ...
      while (true) {
        ...
        lazyStructDecoders.sort(/** @type {function(any,any):number}*/
        (dec1, dec2) => {
        ...
        const firstClient = /** @type {Item | GC}*/
        currDecoder.curr.id.client;
        if (currWrite !== null) {
          let curr = /** @type {Item | GC | null}*/
          currDecoder.curr;
          ...
          if (firstClient !== currWrite.struct.id.client) {
            ...
            if (currWrite.struct.id.clock + currWrite.struct.length < curr.id.clock) {
              ...
              if (!currWrite.struct.mergeWith(/** @type {any}*/
              curr)) {
                writeStructToLazyStructWriter(lazyStructEncoder, currWrite.struct, currWrite.offset);
                currWrite = {
                  struct: curr,
            ...
            if (key !== null) {
              ...
              */
              ...
              if (this.adds(item)) {
                ...
                if (this.deletes(item)) {
                  action = 'delete';
                  oldValue = array__namespace.last(/** @type {Item}*/
    ...
    */
    class AbstractType {
      ...
      */
      get parent() {
        return this._item ? /** @type {AbstractType<any>}*/
        ...
        switch (c.constructor) {
          ...
          default:
            ...
            switch (c.constructor) {
              case Uint8Array:
              case ArrayBuffer:
                left = new Item(createID(ownClientId, getState(store, ownClientId)), left, left && left.lastId, right, right && right.id, parent, null, new ContentBinary(new Uint8Array(/** @type {Uint8Array}*/
                c)));
                left.integrate(transaction, 0);
                break;
              case Doc:
                left = new Item(createID(ownClientId, getState(store, ownClientId)), left, left && left.lastId, right, right && right.id, parent, null, new ContentDoc(/** @type {Doc}*/
                c));
                left.integrate(transaction, 0);
                break;
              default:
    ...
    const typeListInsertGenerics = (transaction, parent, index, content) => {
      ...
      if (marker !== null) {
        ...
        if (index === 0) {
          ...
          n = n.prev;
          // important! get the left undeleted item so that we can actually decrease index
      ...
      if (value == null) {
        ...
        switch (value.constructor) {
          ...
          case String:
            ...
            break;
          case Uint8Array:
            content = new ContentBinary(/** @type {Uint8Array}*/
            value);
            break;
          case Doc:
            content = new ContentDoc(/** @type {Doc}*/
            value);
            break;
          default:
    ...
    * @function
    */
    const createMapIterator = map => iterator__namespace.iteratorFilter(map.entries(), /** @param {any} entry*/
    ...
    */
    class YArray extends AbstractType {
      ...
      */
      map(f) {
        return typeListMap(this, /** @type {any}*/
        f);
      }
      /**
      * Executes a provided function on once on overy element of this YArray.
    ...
    */
    class YMap extends AbstractType {
      ...
      */
      keys() {
        return iterator__namespace.iteratorMap(createMapIterator(this._map), /** @param {any} v*/
        v => v[0]);
      }
      /**
      ...
      */
      forward() {
        ...
        switch (this.right.content.constructor) {
          ...
          case ContentFormat:
            if (!this.right.deleted) {
              updateCurrentAttributes(this.currentAttributes, /** @type {ContentFormat}*/
              this.right.content);
            }
            break;
        }
    ...
    const findNextPosition = (transaction, pos, count) => {
      while (pos.right !== null && count > 0) {
        switch (pos.right.content.constructor) {
          ...
          case ContentFormat:
            if (!pos.right.deleted) {
              updateCurrentAttributes(pos.currentAttributes, /** @type {ContentFormat}*/
              pos.right.content);
            }
            break;
        }
    ...
    */
    const insertNegatedAttributes = (transaction, parent, currPos, negatedAttributes) => {
      ...
      while (currPos.right !== null && (currPos.right.deleted === true || currPos.right.content.constructor === ContentFormat && equalAttrs(negatedAttributes.get(/** @type {ContentFormat}*/
      currPos.right.content.key), /** @type {ContentFormat}*/
      currPos.right.content.value))) {
        if (!currPos.right.deleted) {
          negatedAttributes.delete(/** @type {ContentFormat}*/
    ...
    const minimizeAttributeChanges = (currPos, attributes) => {
      ...
      while (true) {
        if (currPos.right === null) {
          break;
        } else if (currPos.right.deleted || currPos.right.content.constructor === ContentFormat && equalAttrs(attributes[/** @type {ContentFormat}*/
        currPos.right.content.key] || null, /** @type {ContentFormat}*/
    ...
    **/
    const insertText = (transaction, parent, currPos, text, attributes) => {
      ...
      // insert content
      const content = text.constructor === String ? new ContentString(/** @type {string}*/
    ...
    const cleanupFormattingGap = (transaction, start, end, startAttributes, endAttributes) => {
      while (end && end.content.constructor !== ContentString && end.content.constructor !== ContentEmbed) {
        if (!end.deleted && end.content.constructor === ContentFormat) {
          updateCurrentAttributes(endAttributes, /** @type {ContentFormat}*/
          end.content);
        }
        end = end.right;
      }
        ...
        while (end) {
          if (end.deleted === false) {
            switch (end.content.constructor) {
              case ContentFormat:
                updateCurrentAttributes(currentAttributes, /** @type {ContentFormat}*/
                end.content);
                break;
              case ContentEmbed:
              case ContentString:
        ...
        if (this._delta === null) {
          ...
          */
          ...
          transact(y, transaction => {
            ...
            */
            const attributes = {};
            // counts added or removed new attributes for retain
            /**
            * @type {string|object}
            */
            let insert = '';
      ...
      _callObserver(transaction, parentSubs) {
        ...
        if (!transaction.local) {
          ...
          for (const [client, afterClock] of transaction.afterState.entries()) {
            ...
            iterateStructs(transaction, /** @type {Array<Item|GC>}*/
      ...
      next() {
        ...
        */
        ...
        if (n !== null && (!this._firstCall || n.deleted || !this._filter(type))) {
          ...
          } while (n !== null && (n.deleted || !this._filter(/** @type {ContentType}*/
          n.content.type)));
        }
    ...
    class YXmlElement extends YXmlFragment {
      ...
      */
      get nextSibling() {
        ...
        return n ? /** @type {YXmlElement|YXmlText}*/
        /** @type {ContentType}*/
        n.content.type : null;
      }
      /**
    ...
    class ContentType {
      ...
      */
      gc(store) {
        ...
        this.type._map.forEach(/** @param {Item | null} item*/
        item => {
          while (item !== null) {
            item.gc(store, true);
            item = item.left;
    ...
    */
    const redoItem = (transaction, item, redoitems) => {
      ...
      let parentItem = /** @type {AbstractType<any>}*/
      item.parent._item;
      /**
      * @type {Item|null}
      */
      ...
      */
      ...
      const redoneItem = new Item(nextId, left, left && left.lastId, right, right && right.id, parentItem === null ? item.parent : /** @type {ContentType}*/
      ...
      */
      integrate(transaction, offset) {
        ...
        if (this.parent) {
          ...
          addChangedTypeToTransaction(transaction, /** @type {AbstractType<any>}*/
          this.parent, this.parentSub);
          if (/** @type {AbstractType<any>}*/
      ...
      */
      mergeWith(right) {
        if (this.constructor === right.constructor && compareIDs(right.origin, this.lastId) && this.right === right && compareIDs(this.rightOrigin, right.rightOrigin) && this.id.client === right.id.client && this.id.clock + this.length === right.id.clock && this.deleted === right.deleted && this.redone === null && right.redone === null && this.content.constructor === right.content.constructor && this.content.mergeWith(right.content)) {
          const searchMarker = /** @type {AbstractType<any>}*/
  ...
  "6VMiW": [function (require, module, exports) {
    ...
    * @param {bigint} num
    */
    const writeBigInt64 = (encoder, num) => /** @type {any}*/
    writeOnDataView(encoder, 8).setBigInt64(0, num, false);
    /**
    * @param {Encoder} encoder
    * @param {bigint} num
    */
    const writeBigUint64 = (encoder, num) => /** @type {any}*/
    ...
    */
    const readVarString = decoder => {
      ...
      if (remainingLen === 0) {
        ...
        // remember to decrease remainingLen
        if (--remainingLen < 100) {
          ...
          while (remainingLen > 0) {
            ...
            encodedString += String.fromCodePoint.apply(null, /** @type {any}*/
            bytes);
    ...
    * @param {Decoder} decoder
    */
    const readBigInt64 = decoder => /** @type {any}*/
    readFromDataView(decoder, 8).getBigInt64(0, false);
    /**
    * @param {Decoder} decoder
    */
    const readBigUint64 = decoder => /** @type {any}*/
  ...
  "7iFR9": [function (require, module, exports) {
    ...
    */
    ...
    /*istanbul ignore next*/
    const utf8TextEncoder = /** @type {TextEncoder}*/
    ...
    */
    ...
    /*istanbul ignore next*/
    exports.utf8TextDecoder = typeof TextDecoder === 'undefined' ? null : new TextDecoder('utf-8', {
      fatal: true,
      ignoreBOM: true
    });
    /*istanbul ignore next*/
    ...
    * @return {string}
    */
    const _decodeUtf8Native = buf => /** @type {TextDecoder}*/
  ...
  "1wzWf": [function (require, module, exports) {
    ...
    * @function
    */
    const onChange = eventHandler => usePolyfill || addEventListener('storage', /** @type {any}*/
    eventHandler);
  ...
  "12xy1": [function (require, module, exports) {
    ...
    */
    ...
    const uuidv4 = () => uuidv4Template.replace(/[018]/g, /** @param {number} c*/
  ...
  "1vEZw": [function (require, module, exports) {
    ...
    _parcelHelpers.export(exports, "cryptoRandomBuffer", function () {
  ...
  "2yVOU": [function (require, module, exports) {
    ...
    * @return {boolean}
    */
    const equalityFlat = (a, b) => a === b || a != null && b != null && a.constructor === b.constructor && (a instanceof Array && array.equalFlat(a, /** @type {Array<T>}*/
  ...
  "5ZVxg": [function (require, module, exports) {
    ...
    */
    ...
    /*istanbul ignore next*/
    const domParser = /** @type {DOMParser}*/
    ...
    */
    /*istanbul ignore next*/
    const getElementById = id => /** @type {HTMLElement}*/
    ...
    */
    /*istanbul ignore next*/
    const parseFragment = html => fragment(/** @type {any}*/
    ...
    */
    /*istanbul ignore next*/
    const parseElement = html => /** @type HTMLElement*/
    ...
    const _computeLineSpans = args => {
      ...
      for (; i < args.length; i++) {
        ...
        if (!(content instanceof Symbol)) {
          ...
          spans.push(dom.element('span', [], [dom.text(/** @type {string}*/
          content)]));
        }
      }
      return spans;
  ...
  "1K0Ha": [function (require, module, exports) {
    var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
    _parcelHelpers.defineInteropFlag(exports);
    _parcelHelpers.export(exports, "addIframe", function () {
      return addIframe;
    });
    _parcelHelpers.export(exports, "convertType", function () {
      return convertType;
    });
  ...
  "7sBfv": [function (require, module, exports) {
    ...
    class Message {
      ...
      /*convert*/
      convertSent(data) {
        return _helpers.convertType(data, this.sentDataType);
      }
...
},{"../CSDT/dist/csdt":"b1pkp","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5gA8y":[function(require,module,exports) {
"use strict";
...
},{"../CSDT/dist/csdt":"b1pkp"}],"2aZ0c":[function(require,module,exports) {
